...
/**
 * Bridge runtime secret resolver. Mirrors the openclaw-style
 ...
 * start` working without `lark-codex-bridge` on $PATH).
 */
 ...
 * `ref.id`. Implements the same protocol openclaw-style
 ...
 * self-hosting via `lark-codex-bridge secrets get`), short-circuit and
