 ...
 * leak the bot's App Secret. Mirrors the common openclaw-style `SecretRef`
 * shape so secrets can live outside config.json.
 *
...
export interface AppAccess {
   ...
   * (/account, /config, /exit, /reconnect, /cd, /ws). Empty /
